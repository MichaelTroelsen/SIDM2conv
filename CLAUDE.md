...
| Charles Deenen (MoN/Deenen replay) → Driver 11 | 6 clean wins (Ding, B_A_T, LotR, After_the_War, Zamzara all exactly 100/100; Astro 77.4/91.5); 10/19 located | 🚧 + 8 freebies at 100% (3 SM shim, 2 Hubbard, 3 MoN-TTWII sub0); builder REFUSES implausible decodes (`bin/`, not default); see `docs/players/DEENEN.md` |
