# Changelog Archive - v1.x Releases

**Archive Period**: December 2025 (Foundation Phase)
**Versions**: v1.0.0 - v1.4.0

This archive contains the changelog entries for the v1.x release series, which established the core conversion pipeline, validation system, and SF2 viewer.

**Key Milestones**:
- v1.0.0: Complete conversion pipeline
- v1.3.0: Siddump integration and hybrid extraction
