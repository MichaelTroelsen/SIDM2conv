...
| **HardTrack Composer** (Longhair/Brush, Elysium 1992) | [HARDTRACK.md](HARDTRACK.md) | **RE stage only** — parser, no converter, not wired | sequencer decode 88.4% (sequencer-pitch notes) / 2.6% (program-driven notes) — two separate columns, see matrix; 8 of 33 files at exactly 100.0% | `SID/Shogoon/` (38 of 150 files; corpus is mixed-player) |
