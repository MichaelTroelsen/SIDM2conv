...
| **HardTrack Composer** (Longhair/Brush, Elysium 1992) | [HARDTRACK.md](HARDTRACK.md) | `bin/` only (Stage A), not wired | parser 88.4% / Stage A 90.6% on sequencer-pitch notes (Stage A > parser is an artifact, see matrix); 6 of the 8 parser-100% files are Stage A 100.0% | `SID/Shogoon/` (38 of 150 files; corpus is mixed-player) |
