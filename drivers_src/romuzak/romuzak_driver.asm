...
fp_dec:
        ...
        ; (shared filter-table format with Galway/MoN), ADD rows only ever
        ; byte0 in [$00,$0F] -- [$10,$8F] is genuinely dead space, so
        ; widening to $80 reclassifies nothing that was ever emitted. It
        ; fixes a real hazard: SF2II's own CMP is only correct for
        ; |A-operand| <= 127, so `cmp #$90` mis-sets carry in the real
