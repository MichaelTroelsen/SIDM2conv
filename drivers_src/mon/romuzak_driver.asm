...
dp_vib:
        ...
        ; Cybernoid_II's original opens $1F,$3F,$3F while the driver emitted
        ; $0F,$1F,$3F. Six differing siddump lines in 350 frames, all of them
        ; this. digi_stream still runs after, so the digi keeps the last word.
.if DIGI_SPIKE
