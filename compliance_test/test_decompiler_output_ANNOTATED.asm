...
; X   $A014    0      $A017    DEAD       $a014: ca           DEX
; X   $A017    3      $A046    live       $a017: ae a9 a7     LDX  $a7a9
; X   $A017    3      $A046    live       $a017: ae a9 a7     LDX  $a7a9
; A   $A01A    2      $A023    live       $a01a: bd 22 a8     LDA  $a822,x
; A   $A01A    2      $A023    live       $a01a: bd 22 a8     LDA  $a822,x
; A   $A023    1      $A026    live       $a023: bd 23 a8     LDA  $a823,x
; A   $A023    1      $A026    live       $a023: bd 23 a8     LDA  $a823,x
; A   $A026    1      $A02B    live       $a026: 29 0f        AND  #$0f
; A   $A026    1      $A02B    live       $a026: 29 0f        AND  #$0f
; A   $A02B    1      $A02E    live       $a02b: bd 23 a8     LDA  $a823,x
; A   $A02B    1      $A02E    live       $a02b: bd 23 a8     LDA  $a823,x
; A   $A02E    1      $A033    live       $a02e: 29 70        AND  #$70
; A   $A02E    1      $A033    live       $a02e: 29 70        AND  #$70
; A   $A033    4      $A041    live       $a033: a9 02        LDA  #$02
; A   $A033    4      $A041    live       $a033: a9 02        LDA  #$02
; ... (2 more lifecycles not shown)
;
;==============================================================================
;
